...
export default function Input({ folders, setFolders, onComplete, onGoToStep, onLogoClick }) {
  ...
  const handleUploadConfirm = () => {
    ...
    reader.onload = async (e) => {
      try {
        ...
        // Upload to backend; #Consumption → CONSUMPTION, #Reference → REFERENCE
        ...
        try {
          ...
          // Continue so the file is still usable locally
        }
  ...
  return (
    <div className="bg-white fixed inset-0 overflow-hidden" data-name="INPUT">
      ...
      <div ref={mainContentRef} className="absolute left-[64px] right-[64px] top-[132px] bottom-[32px] flex items-stretch">
        ...
        <div className="flex-1 h-full pt-[24px] pb-[24px] pl-[12px] relative">
